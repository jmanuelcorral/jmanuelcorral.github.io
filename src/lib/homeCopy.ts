...
export const HOME_COPY: Record<Locale, HomeCopy> = {
  es: {
    ...
    cv: {
      eyebrow: 'Currículum',
      title: 'CV online y descargas',
      sub: 'Versión online navegable más dos PDFs listos para imprimir: una corta de una página y una extendida con proyectos desglosados.',
      ...
      dlShortS: 'PDF · 1 página A4',
      dlExtT: 'CV — versión extendida',
      dlExtS: 'PDF · 3 páginas A4',
  ...
  en: {
    ...
    cv: {
      eyebrow: 'Résumé',
      title: 'Online résumé & downloads',
      sub: 'A browsable online version plus two print-ready PDFs: a one-page short version and an extended one with projects broken down.',
      ...
      dlShortS: 'PDF · 1 A4 page',
      dlExtT: 'Résumé — extended version',
      dlExtS: 'PDF · 3 A4 pages',
      idxT: 'Version index',
